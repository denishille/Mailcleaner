...
CATEGORIES = [
    ...
    ("life", "Lebenserwartung", "Jahre", "dec1", "Lebenserwartung bei Geburt"),
    ...
    ("popgrowth", "Bevölkerungswachstum", "%", "dec2", "Jährliches Wachstum (kann negativ sein)"),
    ("urban", "Urbanisierung", "%", "dec1", "Anteil Stadtbevölkerung"),
    ("density", "Bevölkerungsdichte", "Einw./km²", "int", "Einwohner je km²"),
    ("forest", "Waldanteil", "%", "dec1", "Anteil Waldfläche"),
    ("coast", "Küstenlänge", "km", "int", "Länge der Küste"),
    ...
    ("internet", "Internetnutzer", "%", "dec1", "Anteil der Bevölkerung"),
    ("infl", "Inflation", "%", "dec1", "Verbraucherpreise (Rang 1 = am höchsten)"),
    ("unemp", "Arbeitslosigkeit", "%", "dec1", "Rang 1 = am höchsten"),
    ("exports", "Exporte", "$", "money", "Waren- und Dienstleistungsexporte"),
    ("mil", "Militärausgaben", "% BIP", "dec1", "Anteil am BIP"),
    ("obes", "Übergewicht", "%", "dec1", "Adipositas-Rate Erwachsene"),
    ("alc", "Alkoholkonsum", "l/Kopf", "dec2", "Liter reiner Alkohol pro Kopf und Jahr"),
]
