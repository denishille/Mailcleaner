...
CATEGORIES = [
    ("pop", "Einwohner", "", "int", "Gesamtbevölkerung"),
    ("area", "Fläche", "km²", "int", "Gesamtfläche"),
    ("gdppc", "BIP pro Kopf", "$", "money", "Reales BIP pro Kopf (Kaufkraftparität)"),
    ("gdp", "BIP gesamt", "$", "money", "Reales BIP (Kaufkraftparität)"),
    ("life", "Lebens\u00aderwartung", "Jahre", "dec1", "Lebenserwartung bei Geburt"),
    ("medage", "Medianalter", "Jahre", "dec1", "Ältestes Land = Rang 1"),
    ("birth", "Geburtenrate", "‰", "dec1", "Geburten je 1.000 Einwohner"),
    ("fert", "Fertilität", "Kinder/Frau", "dec2", "Kinder je Frau"),
    ("popgrowth", "Bevölkerungs\u00adwachstum", "%", "dec2", "Jährliches Wachstum (kann negativ sein)"),
    ("urban", "Urbani\u00adsierung", "%", "dec1", "Anteil Stadtbevölkerung"),
    ("density", "Bevölkerungs\u00addichte", "Einw./km²", "int", "Einwohner je km²"),
    ("forest", "Waldanteil", "%", "dec1", "Anteil Waldfläche"),
    ("coast", "Küsten\u00adlänge", "km", "int", "Länge der Küste"),
    ("high", "Höchster Punkt", "m", "int", "Höhe des höchsten Punkts"),
    ("borders", "Nachbarländer", "", "int", "Anzahl Landgrenzen"),
    ("co2", "CO₂-Ausstoß", "Mt", "dec1", "Gesamtemissionen (Rang 1 = am meisten)"),
    ("renew", "Erneuerbare Energie", "%", "dec1", "Anteil an installierter Stromkapazität"),
    ("internet", "Internet\u00adnutzer", "%", "dec1", "Anteil der Bevölkerung"),
    ("infl", "Inflation", "%", "dec1", "Verbraucherpreise (Rang 1 = am höchsten)"),
    ("unemp", "Arbeits\u00adlosigkeit", "%", "dec1", "Rang 1 = am höchsten"),
    ("exports", "Exporte", "$", "money", "Waren- und Dienstleistungsexporte"),
    ("mil", "Militär\u00adausgaben", "% BIP", "dec1", "Anteil am BIP"),
    ("obes", "Übergewicht", "%", "dec1", "Adipositas-Rate Erwachsene"),
    ("alc", "Alkohol\u00adkonsum", "l/Kopf", "dec2", "Liter reiner Alkohol pro Kopf und Jahr"),
]
